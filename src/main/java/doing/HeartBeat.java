...
public class HeartBeat extends Thread {// sends a heartbeat message to the
										// multicast group every 60 seconds
	...
	static public void doHbCheck() {// checks the HB status of all users and
									// send leave if > 5
		int hb;
