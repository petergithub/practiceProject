 ...
 * a IM program
 */
public class UdpIM extends Frame implements Runnable {
	...
	class myMouseListener extends MouseAdapter { // 送数据
		public void mouseClicked(MouseEvent e) { // 每次 Click 按钮就发送信息到目的端主机
			...
			try {
				...
				DatagramPacket DP = new DatagramPacket(msg.getBytes(),
						msg.getBytes().length, InetAddress.getByName(ipStr),
